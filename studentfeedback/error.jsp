...
<div class="container error-container">
	<div class="row  d-flex align-items-center justify-content-center">
		<div class="col-md-12 text-center">
			...
			<h2 class="small-text">INAVLID USERNAME OR PASSWORD</h2>

		</div>
		
			
			
			<a href="index.jsp"><input type="button" name="homepage" value="HOMEPAGE" class="button button-dark-blue iq-mt-15 text-center"/></a><br><br>
		</div>
